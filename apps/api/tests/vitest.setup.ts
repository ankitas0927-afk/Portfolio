...
process.env.OWNER_PUBLIC_EMAIL = 'ankita7003244@gmail.com';
process.env.OWNER_PUBLIC_PHONE = '+91 6387454579';
process.env.OWNER_CITY = 'Sankrail, Howrah';
process.env.OWNER_STATE = 'West Bengal';
process.env.OWNER_COUNTRY = 'India';
